                ...
                <div class="d-flex">
                                    ...
                                    <div class="n-header--top__left main-menu">
                                        ...
                                        <div class="container">
                                            <ul class="menu-active-classes ">
                                                ...
                                                <li class="menu-item"><a class="{{ linkActive('website.candidate', 'text-primary') }}"
                                                        href="{{ route('website.candidate') }}">{{ __('find_candidate') }}</a>
                                                </li>
                                                <li class="menu-item"><a class="{{ linkActive('company.dashboard', 'text-primary') }}"
                                        ...
                                        <div class="container">
                                            <ul class="menu-active-classes ">
                                                ...
                                                <li class="menu-item"><a class="{{ linkActive('candidate.dashboard', 'text-primary') }}"
                                                        href="{{ route('candidate.dashboard') }}">{{ __('dashboard') }}</a>
                                                </li>
                                                <li class="menu-item"><a class="{{ linkActive('candidate.job', 'text-primary') }}"
                    ...
                    <div class="n-header--bottom__right">
                        <div class="d-flex align-items-center">
                            ...
                            @endauth
                            @guest
                            <ul class="list-unstyled d-flex align-items-center d-none d-sm-flex justify-content-between">
                                <li>
                                    <a href="{{ route('login') }}" class="btn btn-outline-primary">{{ __('sign_in')
                                        }}</a>
                                </li>
                                <li class="d-none d-sm-block">
