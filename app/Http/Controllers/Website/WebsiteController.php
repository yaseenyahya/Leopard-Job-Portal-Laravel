...
class WebsiteController extends Controller
{
    ...
    public function termsCondition()
    {
        ...
        if ($current_language) {
            ...
            $exist_cms_content =  CmsContent::where('translation_code', $current_language->code)->where('page_slug', 'terms_condition_page')->first();
    ...
    {
        $termscondition = Cms::select('privary_page')->first();
        ...
        if ($current_language) {
            ...
            $exist_cms_content =  CmsContent::where('translation_code', $current_language->code)->where('page_slug', 'privacy_page')->first();
        ...
        return view('website.pages.privacy-policy', compact('termscondition', 'privacy_page'));
    }
