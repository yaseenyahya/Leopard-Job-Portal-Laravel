                                ...
                                <div class="d-flex justify-content-between btn-group flex-column flex-md-row ">
                                    <div class="row">
                                        @php
                                            ...
                                            $linkedin = config('zakirsoft.linkedin_login') && config('zakirsoft.linkedin_id') && config('zakirsoft.linkedin_secret');
                                            $github = config('zakirsoft.github_login') && config('zakirsoft.github_id') && config('zakirsoft.github_secret');
                                        @endphp
